...
-- Created by hham3 on 2023-04-12, 오후 1:27:53 --
------------------------------------------------

set define off
spool paDbObjectBackup_20230412.log
            ...
            SELECT G.GOODS_CODE
             ...
             WHERE G.MODIFY_DATE > SYSDATE - 1
               ...
               AND G.GOODS_CODE NOT IN ('25677110','25677126','25677213','25679058','25679101','25679139','25679178','25679186','25697949','25697958',
                                        ...
                                        ,'24310357','22157594','28790739','31574394','31574395','31574397','31574400','31574402','31574405','31600572','31063342','31068348','31464324'
                                        , '29441229', '29929539', '31163941', '31423333' -- wemp 수기연동
      ...
      FROM (
            ...
            SELECT COPN.GOODS_CODE
             ...
             WHERE COPN.PA_CODE IN ('51','52')
               ...
               AND COPN.APPROVAL_STATUS <> '15' -- 승인 대기중 상태는 제외
  ...
  */
  ...
  SELECT CASE
    ...
    FROM (SELECT PA_ORDER_GB, PA_SHIP_NO
          ...
          --반품처리완료.
           WHERE PA_SHIP_NO NOT IN ('G1200518586'
                                   ,'G1201068090' -- 1/4 주문생성전 취소
                                   ,'G1210131866' -- 1/17 주문생성전 취소
                                   ,'G1223261026' -- 2/9 주문생성전 취소
                                   ,'G1230711818' -- 2/22 주문생성전 취소
                                   ,'351454180'   -- 3/22 주문생성전 취소
                                   ,'G1254575882' -- 4/4 주문생성전 취소
                                   ,'353704061'   -- 4/10 주문생성전 취소
                                    )
  ...
  SELECT CASE
    ...
    FROM ( SELECT HE.ORD_NO AS PA_ORDER_NO
            ...
            WHERE HE.INSERT_DATE > SYSDATE - 3
              AND HE.ORD_NO NOT IN  ('230315360945','230316429016'));
  IF (IS_EXISTED > 0) THEN
    INSERT_ERROR_LOG();
  END IF;  
  ...
  SELECT CASE
    ...
    FROM (SELECT * 
           ...
           WHERE OD.ORDER_DATE > SYSDATE - 1
             ...
             AND OD.ORDER_NO NOT IN ('20230306559959','20230324139698','20230328665673','20230405444049'));   
  IF (IS_EXISTED > 0) THEN
    INSERT_ERROR_LOG();
  END IF; 
