...
-- Created by hham3 on 2023-10-24, 오후 3:25:13 --
------------------------------------------------

set define off
spool paDbObjectBackup_20231024.log
...
*/
  ...
  /*P354. [제휴_하프클럽] 제주/도서산간배송불가 배송템플릿 점검, 검출시 TPAHALFGOODS.TRANS_TARGET_YN='1'로 UPDATE*/
    ...
    v_flag      := 'P355';    v_error_msg := '[확인_P355][제휴_티몬] TPAGOODSTARGET PA_CODE=91 건';
    is_existed  := 0;        
  ...
  SELECT CASE
   ...
   WHERE ((HP IS NULL AND TEL = '000000000000') OR
     ...
     AND CUST_NO NOT IN ('202112132848' -- 12/3
                                    ...
                                    ,'202201225006' -- 23.09.08
                                    ,'202310447300' -- 23.10.11
                                    ,'202310484679' -- 23.10.13
                                    ,'202310681647' -- 23.10.24
                         );
  ...
  SELECT CASE
    ...
    FROM ( SELECT HE.ORD_NO AS PA_ORDER_NO
            ...
            WHERE HE.INSERT_DATE > SYSDATE - 3
              AND HE.ORD_NO NOT IN  ('231005834479'));
  DBMS_OUTPUT.PUT_LINE('V_FLAG : ' || V_FLAG || ', TIME : ' || TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS'));
  IF (IS_EXISTED > 0) THEN
    INSERT_ERROR_LOG();
  END IF;  
  ...
  SELECT CASE
    ...
    FROM (SELECT * 
           ...
           WHERE OD.ORDER_DATE > SYSDATE - 1
             ...
             AND OD.ORDER_NO NOT IN ('20230927866519'));
  DBMS_OUTPUT.PUT_LINE('V_FLAG : ' || V_FLAG || ', TIME : ' || TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS'));
  IF (IS_EXISTED > 0) THEN
    INSERT_ERROR_LOG();
  END IF; 
