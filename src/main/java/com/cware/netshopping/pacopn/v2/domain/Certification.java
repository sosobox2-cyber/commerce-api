...
public class Certification {
	...
	public List<Map<String, String>> getCertificationAttachments() {
		return certificationAttachments;
	}

	public void setCertificationAttachments(List<Map<String, String>> certificationAttachments) {
		this.certificationAttachments = certificationAttachments;
	}

	@Override
	public String toString() {
		return "Certification [certificationType=" + certificationType + ", certificationCode=" + certificationCode
				+ ", certificationAttachments=" + certificationAttachments + "]";
	}
