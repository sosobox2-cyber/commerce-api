package com.cware.netshopping.pacopn.goods.service;
...
public interface PaCopnGoodsService {
	 ...
	 * @throws Exception
	 */
	int insertPaCopnGoodsTransLogTx(PaGoodsTransLog paGoodsTransLog) throws Exception;
	 ...
	 * @throws Exception
	 */
	String savePaCopnGoodsAttriTx(List<PaCopnGoodsAttri> copnGoodsAttri) throws Exception;

	/**
	 * 상품전송결과 저장
	 * 프로모션 별 운영관리 기능 효율화(REQ_PRM_040)
	 * @param PaCopnGoodsVO, List<PaGoodsdtMapping, paPromoTarget>
	 * @return String
	 * @throws Exception
	 */
	String savePaCopnGoodsTx(PaCopnGoodsVO paCopnGoods, List<PaGoodsdtMapping> goodsdtMapping, List<PaPromoTarget> paPromoTargetList) throws Exception;
	String savePaCopnGoodsFailTx(PaCopnGoodsVO paCopnGoods) throws Exception;
	 ...
	 * @param goodsPriceApply
	 * @return
	 * @throws Exception
	 */
	String savePaCopnGoodsTx(PaCopnGoodsVO paCopnGoods, List<PaGoodsdtMapping> goodsdtMapping, List<PaPromoTarget> paPromoTargetList, PaGoodsPriceApply goodsPriceApply) throws Exception;
	 ...
	 * @throws Exception
	 */
	String savePaCopnGoodsDtOptionTx(PaCopnGoodsdtMappingVO goodsdtMapping) throws Exception;
	 ...
	 * @throws Exception
	 */
	String savePaCopnGoodsSellTx(PaCopnGoodsdtMappingVO paCopnGoodsdtMapping) throws Exception;
	 ...
	 * @throws Exception
	 */
	String updatePaCopnGoodsdtOrderTx(PaCopnGoodsdtMappingVO paCopnGoodsMapping) throws Exception;
	 ...
	 * @throws Exception
	 */
	String updatePaCopnGoodsPriceDiscountTx(PaCopnGoodsdtMappingVO paCopnGoodsMapping, List<PaPromoTarget> paPromoTargetList) throws Exception;
	...
	/**
	 * REQ_PRM_041 제휴OUT 딜 상품 전송결과 저장
	 * @param HashMap<String, Object> paCopnAlcoutDealInfo
	 * @return String
	 * @throws Exception
	 */
	...
	/**
	 * REQ_PRM_041 상품조회 API 제휴OUT 딜 옵션코드 UPDATE
	 * 
	 * @param PaCopnGoodsdtMappingVO
	 * @return String
	 * @throws Exception
	...
	/**
	 * 쿠팡 상품수정 - REQ_PRM_041 제휴OUT 딜 수정대상 딜 목록
	 * @param ParamMap
	 * @return List
	 * @throws Exception
	 */
	...
	/**
	 * 쿠팡 상품수정API, VENDOR_ID(TPAGOODSDTMAPPING의 PA_OPTION_CODE)가 없는 제휴OUT 딜 조회
	 * 
	 * @param paramMap
	 * @return List
	 * @throws Exception
	...
	/**
	 * 쿠팡 - REQ_PRM_041 상품수정API, 승인완료가 필요한 상품 조회
	 * 
	 * @param
	 * @return List
	 * @throws Exception
	...
	/**
	 * 쿠팡 - REQ_PRM_041 제휴OUT 딜 판매중지, 판매재개 상품 조회
	 * 
	 * @param paramMap
	 * @return List
	 * @throws Exception
	...
	/**
	 * 쿠팡 - REQ_PRM_041 제휴OUT 딜 판매중지, 판매재개 상태 저장
	 * 
	 * @param PaCopnGoodsdtMappingVO
	 * @return String
	 * @throws Exception
	...
	/**
	 * 쿠팡 - REQ_PRM_041 제휴OUT 딜 상품아이템 수량변경 API, 수량변경 대상 조회
	 * 
	 * @param paramMap
	 * @return List
	 * @throws Exception
	...
	/**
	 * 쿠팡 - REQ_PRM_041 제휴OUT 딜 판매중지대상 조회
	 * 
	 * @param paramMap
	 * @return List
	 * @throws Exception
	...
	/**
	 * 쿠팡 - REQ_PRM_041 제휴OUT 딜 판매재게 대상 조회
	 * 
	 * @param paramMap
	 * @return List
	 * @throws Exception
