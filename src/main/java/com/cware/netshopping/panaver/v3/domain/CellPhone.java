...
public class CellPhone {
	...
	public void setExtraBurden(String extraBurden) {
		this.extraBurden = extraBurden;
	}
	...
	public String toString() {
		return "CellPhone [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "certificationType=" + certificationType + "releaseDate=" + releaseDate + "releaseDateText=" + releaseDateText + "manufacturer=" + manufacturer + "importer=" + importer + "producer=" + producer 
				 + "size=" + size + "weight=" + weight + "telecomType=" + telecomType + "joinProcess=" + joinProcess + "extraBurden=" + extraBurden + "specification=" + specification + "warrantyPolicy=" + warrantyPolicy + "afterServiceDirector=" + afterServiceDirector +"]";
	}
