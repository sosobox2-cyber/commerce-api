...
public class MobileCoupon {
	...
	public void setUsableStore(String usableStore) {
	...
	public String toString() {
		return "MobileCoupon [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "issuer=" + issuer + "usableCondition=" + usableCondition + "usableStore=" + usableStore + "cancelationPolicy=" + cancelationPolicy + "customerServicePhoneNumber=" + customerServicePhoneNumber+ "]";
	}
