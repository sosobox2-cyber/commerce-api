...
public class Navigation {
	...
	public void setFreeCostPeriod(String freeCostPeriod) {
		this.freeCostPeriod = freeCostPeriod;
	}
	...
	public String toString() {
		return "Navigation [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "certificationType=" + certificationType + "ratedVoltage=" + ratedVoltage + "powerConsumption=" + powerConsumption + "releaseDate=" + releaseDate
				 + "releaseDateText=" + releaseDateText + "manufacturer=" + manufacturer + "size=" + size + "weight=" + weight+ "specification=" + specification + "updateCost=" + updateCost + "freeCostPeriod=" + freeCostPeriod + "warrantyPolicy=" + warrantyPolicy + "afterServiceDirector=" + afterServiceDirector +"]";
	}
