...
public class SleepingGear {
	...
	public String toString() {
		return "SleepingGear [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "material=" + material + "color=" + color + "size=" + size + "components=" + components + "manufacturer=" + manufacturer + "caution=" + caution + "warrantyPolicy=" + warrantyPolicy + "afterServiceDirector=" + afterServiceDirector + "]";
	}
