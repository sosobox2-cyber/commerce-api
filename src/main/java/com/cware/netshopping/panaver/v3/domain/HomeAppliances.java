...
public class HomeAppliances {
	...
	public String toString() {
		return "HomeAppliances [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 ...
				 + "releaseDateText=" + releaseDateText + "manufacturer=" + manufacturer + "size=" + size + "additionalCost=" + additionalCost + "warrantyPolicy=" + warrantyPolicy + "afterServiceDirector=" + afterServiceDirector +"]";
	}
