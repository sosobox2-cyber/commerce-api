...
public interface PaNaverV3InfoCommonProcess {
	 ...
	 * @throws Exception
	 */
	public ProductOrderInfoAll insertCancelInfoProc(ProductOrderInfoAll cancelInfo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public ProductOrderInfoAll insertReturnInfo(ProductOrderInfoAll returnInfo) throws Exception;
	 ...
	 * @throws Exception
	 */
	public ProductOrderInfoAll insertExchangeInfo(ProductOrderInfoAll exchangeInfo) throws Exception;
