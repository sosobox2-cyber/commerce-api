...
public class Kids {
	...
	public String toString() {
		return "Kids [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName +"certificationType=" + certificationType  + "size=" + size + "weight=" + weight + "color=" + color+ "material=" + material + "recommendedAge=" + recommendedAge +"releaseDate=" + releaseDate 
				 +"releaseDateText=" + releaseDateText +"manufacturer=" + manufacturer +"caution=" + caution +"warrantyPolicy=" + warrantyPolicy +"afterServiceDirector=" + afterServiceDirector +"numberLimit=" + numberLimit +"]";
	}
