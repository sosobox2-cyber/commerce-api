...
public class ImageAppliances {
	...
	public void setDisplaySpecification(String displaySpecification) {
	...
	public String toString() {
		return "ImageAppliances [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "certificationType=" + certificationType + "ratedVoltage=" + ratedVoltage  + "powerConsumption=" + powerConsumption + "energyEfficiencyRating=" + energyEfficiencyRating + "releaseDate=" + releaseDate +
				  "releaseDateText=" + releaseDateText + "manufacturer=" + manufacturer + "size=" + size + "additionalCost=" + additionalCost + "displaySpecification=" + displaySpecification + "warrantyPolicy=" + warrantyPolicy + "afterServiceDirector=" + afterServiceDirector +"]";
	}
