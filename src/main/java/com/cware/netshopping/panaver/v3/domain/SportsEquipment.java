...
public class SportsEquipment {
	...
	public String toString() {
		return "SportsEquipment [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "certificationType=" + certificationType + "size=" + size + "weight=" + weight+ "color=" + color+ "material=" + material + "components=" + components 
				 +"releaseDate=" + releaseDate +"releaseDateText=" + releaseDateText +"manufacturer=" + manufacturer +"detailContent=" + detailContent +"warrantyPolicy=" + warrantyPolicy +"afterServiceDirector=" + afterServiceDirector+"]";
	}
