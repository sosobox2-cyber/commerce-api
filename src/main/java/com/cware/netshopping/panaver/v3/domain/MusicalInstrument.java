...
public class MusicalInstrument {
	...
	public String toString() {
		return "MusicalInstrument [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "size=" + size + "color=" + color+ "material=" + material + "components=" + components +"releaseDate=" + releaseDate +"releaseDateText=" + releaseDateText +"manufacturer=" + manufacturer
				 +"detailContent=" + detailContent +"warrantyPolicy=" + warrantyPolicy +"afterServiceDirector=" + afterServiceDirector+"]";
	}
