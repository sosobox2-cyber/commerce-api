...
public class SeasonAppliances {
	...
	public String toString() {
		return "SeasonAppliances [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 ...
				 + "releaseDateText=" + releaseDateText + "manufacturer=" + manufacturer + "size=" + size + "area=" + area+ "installedCharge=" + installedCharge + "warrantyPolicy=" + warrantyPolicy + "afterServiceDirector=" + afterServiceDirector +"]";
	}
