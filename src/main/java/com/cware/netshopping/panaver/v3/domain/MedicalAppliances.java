...
public class MedicalAppliances {
	...
	public String getAdvertisingCertificationType() {
		return advertisingCertificationType;
	}

	public void setAdvertisingCertificationType(String advertisingCertificationType) {
		this.advertisingCertificationType = advertisingCertificationType;
	}
	...
	public String toString() {
		return "MedicalAppliances [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "licenceNo=" + licenceNo +"advertisingCertificationType=" + advertisingCertificationType + "ratedVoltage=" + ratedVoltage +"powerConsumption=" + powerConsumption + "releaseDate=" + releaseDate 
				 + "releaseDateText=" + releaseDateText + "manufacturer=" + manufacturer+ "purpose=" + purpose + "usage=" + usage +"caution=" + caution +"warrantyPolicy" + warrantyPolicy +"afterServiceDirector=" + afterServiceDirector + "]";
	}
