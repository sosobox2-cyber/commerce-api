...
public class CarArticles {
	...
	public void setRoadWorthyCertification(String roadWorthyCertification) {
		this.roadWorthyCertification = roadWorthyCertification;
	}
	...
	public String toString() {
		return "CarArticles [returnCostReason=" + returnCostReason + "noRefundReason=" + noRefundReason + "qualityAssuranceStandard=" + qualityAssuranceStandard + "compensationProcedure=" + compensationProcedure + "troubleShootingContents=" + troubleShootingContents 
				 + "itemName=" + itemName + "modelName=" + modelName + "certificationType=" + certificationType +"releaseDate=" + releaseDate + "releaseDateText=" + releaseDateText +"caution=" + caution + "manufacturer=" + manufacturer + "size=" + size + "applyModel=" + applyModel
				 + "warrantyPolicy=" + warrantyPolicy + "roadWorthyCertification=" + roadWorthyCertification +"afterServiceDirector=" + afterServiceDirector +"]";
	}
