package com.cware.netshopping.panaver.infocommon.process;
...
public interface PaNaverInfoCommonProcess {
	...
	public List<ParamMap> insertCancelInfoProc(HttpServletRequest httpServletRequest, ProductOrderInfo[] cancelList, NaverSignature naverSignature, ChangedProductOrderInfo changedProductOrderInfo) throws Exception;
