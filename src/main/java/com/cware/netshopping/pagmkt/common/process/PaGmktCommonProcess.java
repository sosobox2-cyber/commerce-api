package com.cware.netshopping.pagmkt.common.process;
...
public interface PaGmktCommonProcess {
	 ...
	 * @throws Exception
	 */
	public String savePaGmktEntpSlipUpdate(PaEntpSlip paEntpSlip) throws Exception;
