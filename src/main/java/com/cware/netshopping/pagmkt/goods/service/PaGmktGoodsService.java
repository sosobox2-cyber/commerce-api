package com.cware.netshopping.pagmkt.goods.service;
...
public interface PaGmktGoodsService {
...
//	public String savePaGmktGoodsModifyTx(PaGmktGoodsVO paGmktGoods) throws Exception;
	...
	public String saveGoodsOptionTx(List<PaGoodsdtMapping> paGoodsdtMappingList) throws Exception;
	/** G마켓 상품수정2.0 - 상품등록실패건(옵션)*/
...
//	public String savePaGmktGoodsInsertTx(PaGmktGoodsVO paGmktGoods) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<HashMap<String, Object>> selectGoodsOptionListForResister(HashMap<String, Object> target) throws Exception;
