...
public class PaFapleGoods extends AbstractModel {
	...
	public String getBrandChangeYn() {
		return brandChangeYn;
	}
	public void setBrandChangeYn(String brandChangeYn) {
		this.brandChangeYn = brandChangeYn;
	}
}
