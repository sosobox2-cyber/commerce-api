...
public class PaWempbroadsche extends AbstractVO{
	...
	private String programUseYn;	
	
	private String paGroupCode;
	
	public String getProgramUseYn() {
		return programUseYn;
	}
	public void setProgramUseYn(String programUseYn) {
		this.programUseYn = programUseYn;
	}
	...
	public String getGoodsUseYn() {
		return goodsUseYn;
	}
	public void setGoodsUseYn(String goodsUseYn) {
	...
	public String getPaGodsCode() {
		return paGodsCode;
	}
	public void setPaGodsCode(String paGodsCode) {
		this.paGodsCode = paGodsCode;
	}
