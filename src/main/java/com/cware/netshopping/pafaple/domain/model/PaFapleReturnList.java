...
public class PaFapleReturnList extends AbstractModel {
	...
	private String returningTypeName;
	...
	public String getReturningTypeName() {
		return returningTypeName;
	}
	public void setReturningTypeName(String returningTypeName) {
