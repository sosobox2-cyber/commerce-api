package com.cware.netshopping.passg.goods.process;
...
public interface PaSsgGoodsProcess {
	 ...
	 * @throws Exception
	 */
	String savePaSsgGoods(PaSsgGoodsVO paSsgGoods, List<PaSsgGoodsdtMapping> goodsdtMapping)  throws Exception;
	 ...
	 * @throws Exception 
	 */
	String savePaSsgGoodsError(PaSsgGoodsVO paSsgGoods) throws Exception;
	...
	String updatePaGoodsdtMappingQty(List<PaSsgGoodsdtMapping> paGoodsdtList) throws Exception;
