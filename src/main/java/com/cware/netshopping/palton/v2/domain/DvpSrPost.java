...
public class DvpSrPost {
	...
	public List<DvpSr> getData() {
		return data;
	}

	public void setData(List<DvpSr> data) {
		this.data = data;
	}

	@Override
	public String toString() {
		return "DvpSrPost [returnCode=" + returnCode + ", message=" + message + ", subMessages=" + subMessages
