 ...
 */
@Service
public class KakaoProductService {

	// 카카오 데몬서버
	@Value("${partner.kakao.service.host}")
	String API_SERVER;

	// 판매중지 API 
	@Value("${partner.kakao.service.product.stop}")
	String PRODUCT_STOP_API;

	// 판매재개 API 
	@Value("${partner.kakao.service.product.resume}")
	String PRODUCT_RESUME_API;

	// 재고변경 API 
	@Value("${partner.kakao.service.product.stock}")
	String PRODUCT_STOCK_API;

	// 이미지등록 API 
	@Value("${partner.kakao.service.product.image}")
	String PRODUCT_IMAGE_API;

	// 이미지등록확인 API 
	@Value("${partner.kakao.service.product.image-check}")
	String PRODUCT_IMAGE_CHECK_API;
	 ...
	 * @return
	 */
	public PaTransService registerImageProduct(String goodsCode, String paCode, String procId) {
		String tag = "이미지등록";
		...
		return requestUpdateProduct(goodsCode, tag, PRODUCT_IMAGE_API, params);
	}
	...
	public PaTransService checkImageProduct(String goodsCode, String paCode, String procId) {
		String tag = "이미지등록확인";
		...
		return requestUpdateProduct(goodsCode, tag, PRODUCT_IMAGE_CHECK_API, params);
	}
