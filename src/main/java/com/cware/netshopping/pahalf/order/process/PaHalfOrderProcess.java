package com.cware.netshopping.pahalf.order.process;
...
public interface PaHalfOrderProcess {
	/**
	 ...
	 * @throws Exception
	 */
	public String savePaHalfOrder(Map<String, Object> order) throws Exception;
	/**
	 * 하프클럽 주문 승인 리스트 조회
	 * @param PaHalfOrderListVO
	 * @return
	 ...
	 * @throws Exception
	 */
	public String savePaHalfCancel(Map<String, Object> cancel) throws Exception;
	/**
