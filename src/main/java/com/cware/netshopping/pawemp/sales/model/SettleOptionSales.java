 ...
 * 정상일마감 상품 매출
 */
public class SettleOptionSales {
	...
	//private Long optSaleQty;
	private Long optSaleAmt;
	//private Long optCompleteAmt;
	...
	private Long wmpDiscountBurdenAmt;
	private Long epFee;
	...
	public String getOrderOptNo() {
		return orderOptNo;
	}
	public void setOrderOptNo(String orderOptNo) {
		this.orderOptNo = orderOptNo;
	}
	...
	public String getClaimOptNo() {
		return claimOptNo;
	}
	public void setClaimOptNo(String claimOptNo) {
		this.claimOptNo = claimOptNo;
	}
	...
	//public Long getOptSaleQty() {
	//	return optSaleQty;
	//}
	//public void setOptSaleQty(Long optSaleQty) {
	//	this.optSaleQty = optSaleQty;
	//}
	public Long getOptSaleAmt() {
		return optSaleAmt;
	}
	public void setOptSaleAmt(Long optSaleAmt) {
		this.optSaleAmt = optSaleAmt;
	}
	//public Long getOptCompleteAmt() {
	//	return optCompleteAmt;
	//}
	//public void setOptCompleteAmt(Long optCompleteAmt) {
	//	this.optCompleteAmt = optCompleteAmt;
	//}
	...
	public Long getWmpDiscountBurdenAmt() {
		return wmpDiscountBurdenAmt;
	}
	public void setWmpDiscountBurdenAmt(Long wmpDiscountBurdenAmt) {
		this.wmpDiscountBurdenAmt = wmpDiscountBurdenAmt;
	}
	public Long getEpFee() {
		return epFee;
	}
	public void setEpFee(Long epFee) {
		this.epFee = epFee;
	}
}
