 ...
 */
@Service
public class WempProductService {

	// 위메프 데몬서버
	@Value("${partner.wemp.service.host}")
	String API_SERVER;

	// 판매중지 API 
	@Value("${partner.wemp.service.product.stop}")
	String PRODUCT_STOP_API;

	// 판매재개 API 
	@Value("${partner.wemp.service.product.resume}")
	String PRODUCT_RESUME_API;

	// 재고변경 API 
	@Value("${partner.wemp.service.product.stock}")
