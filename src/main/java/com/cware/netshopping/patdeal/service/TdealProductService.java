 ...
 */
@Service
public class TdealProductService {

	// 티딜 데몬서버
	@Value("${partner.tdeal.service.host}")
	String API_SERVER;

	// 판매중지 API 
	@Value("${partner.tdeal.service.product.stop}")
	String PRODUCT_STOP_API;

	// 재고변경 API
	@Value("${partner.tdeal.service.product.stock}")
	String PRODUCT_STOCK_API;

	// 판매재개 API
	@Value("${partner.tdeal.service.product.resume}")
