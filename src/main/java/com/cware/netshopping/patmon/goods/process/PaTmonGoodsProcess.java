package com.cware.netshopping.patmon.goods.process;
...
public interface PaTmonGoodsProcess {
	 ...
	 * @throws Exception 
	 */
	String updatePaTmonGoodsdtMappingQty(List<PaTmonGoodsdtMappingVO> paGoodsdtList) throws Exception;
	 ...
	 * @throws Exception 
	 */
	String updatePaTmonGoodsdtMappingAdded(List<PaTmonGoodsdtMappingVO> goodsAddedMapping) throws Exception;
	 ...
	 * @throws Exception 
	 */
	String savePaTmonGoodsError(PaTmonGoodsVO paTmonGoods) throws Exception;
