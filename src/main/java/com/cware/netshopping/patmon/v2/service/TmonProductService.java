 ...
 */
@Service
public class TmonProductService {

	// 티몬 데몬서버
	@Value("${partner.tmon.service.host}")
	String API_SERVER;

	// 판매중지 API 
	@Value("${partner.tmon.service.product.stop}")
	String PRODUCT_STOP_API;

	// 판매재개 API 
	@Value("${partner.tmon.service.product.resume}")
	String PRODUCT_RESUME_API;

	// 재고변경 API 
	@Value("${partner.tmon.service.product.stock}")
