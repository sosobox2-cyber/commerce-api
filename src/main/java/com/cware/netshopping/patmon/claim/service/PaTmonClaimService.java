package com.cware.netshopping.patmon.claim.service;
...
public interface PaTmonClaimService {
	 ...
	 * @throws Exception
	 */
	int saveTmonCancelListTx(List<PaTmonCancelListVO> paTmonCancelList) throws Exception;
	...
	String updatePaTmonCancelListTx(ParamMap paramMap) throws Exception;
	
	int updatePaTmonCancelConfirmTx(ParamMap paramMap) throws Exception;
	...
	int saveTmonRedelivaryListTx(List<PaTmonRedeliveryListVO> paTmonReDeliverylList) throws Exception;

	int updatePaTmonHoldYnTx(Map<String, Object> exchangeHoldData) throws Exception;
