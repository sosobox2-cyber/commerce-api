...
@Repository
public interface PaHalfGoodsRepository extends JpaRepository<PaHalfGoods, PaGoodsId> {

    // 판매중지처리
    @Modifying
    @Query(value = "update PaHalfGoods p "
    		+ " set p.transSaleYn = '1' "
    		+ " , p.paSaleGb = '30' "
    		+ " , p.modifyId = :modifyId "
	...
	Slice<PaHalfGoods> findTransTargetList(Pageable pageable);
